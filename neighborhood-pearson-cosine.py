...
def main():
	example_matrix = [[7,6,7,4,5,4], [6,7,np.NaN,4,3,4], [np.NaN, 3, 3, 1, 1, np.NaN], [1, 2, 2, 3, 3, 4], [1, np.NaN, 1, 2, 3, 3]]
	...
	print("Predicted rating for User 3, Item 1 using Pearson Correlatiobn Coefficient %f" % (cosine_rating))
main()
